...
import Step3IDVerification from "./Step3IDVerification";
...
export default function OnboardingWrapper() {
  ...
  return (
    <div className="w-full h-full flex flex-col md:flex-row bg-white dark:bg-[#0a0a0a]">
      
      {/* Sidebar / Progress Section */}
      <div className="w-full md:w-[320px] lg:w-[400px] bg-gray-50 dark:bg-[#111] p-5 md:p-8 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-800 flex flex-col flex-shrink-0 z-20">
      ...
      <div className="flex-1 p-5 md:p-8 lg:p-12 xl:p-16 relative flex flex-col overflow-y-auto">
        <div className="max-w-2xl mx-auto w-full flex-grow flex flex-col">
          ...
          {onboarding.currentStep === 3 && <Step3IDVerification onboarding={onboarding} />}
