...
import { useAgencyRegister } from "@/hooks/useAgencyRegister";
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-transparent p-12 flex flex-col justify-between">
          ...
          <div className="text-white">
            <h1 className="font-serif text-5xl font-bold leading-tight mb-4">
              Start Your <span className="text-[#D4AF37]">Agency</span> Journey
            </h1>
            <p className="text-xl text-zinc-300 font-light max-w-md">
              Create your agent account to open an agency and expand your business.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="text-center md:text-left mb-10">
            ...
            <p className="text-gray-500 dark:text-zinc-400">
              Enter your details to register as an agency owner.
            </p>
          </div>
          ...
          <p className="mt-8 text-center text-gray-500 dark:text-zinc-500 text-sm">
            ...
            <Link href="/agencyportal/login" className="font-semibold text-[#D4AF37] hover:underline">
              Sign In
            </Link>
          </p>
        </div>
